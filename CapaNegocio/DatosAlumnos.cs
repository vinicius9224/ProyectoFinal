...
namespace CapaNegocio
{
    public class DatosAlumnos
    {
        ...
        public void AgregarAlumno(string cod, string nom, string ape, DateTime fecha, string nomRes, string telRes, string colegio, string grado, string domiPersona, string evaluacion, int DeparId, int MuniId, int estado)
        {
            obj.Agregar_Alumnos(cod, nom, ape, fecha, nomRes, telRes, colegio, grado, domiPersona, evaluacion, DeparId, MuniId,estado);
        }
        ...
        {
            obj.Editar_Alumnos(cod, nom, ape, fecha, nomRes, telRes, colegio, grado, domiPersona, evaluacion, DeparId, MuniId, Convert.ToInt32(id), estado);
        }
